...
<div>
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <input type="hidden" id="checkSelectParentId" value="-1">
        
            <tr>
                <td align="right" class="l-table-edit-td">上级渠道:&nbsp;<span style="color:red;">*</span></td>
                <td align="left" class="l-table-edit-td">
                    <input id="parentId" type="hidden" name="parentId">
                    <input id="parentName" type="text" ltype="text" autocomplete="off" onclick="selectChannel()"/>
                </td>
                <td align="right" class="l-table-edit-td">渠道名称:&nbsp;<span style="color:red;">*</span></td>
                <td align="left" class="l-table-edit-td"><input autocomplete="off" name="channelName" type="text" id="channelName" ltype="text" validate="{required:true,maxlength:100}"/></td>
            </tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                    ...
                    <input id="organName" type="text" ltype="text" onclick="selectDepartment()"/>
                </td>
                <td align="right" class="l-table-edit-td">备注:&nbsp;<span style="color:red;"></span></td>
                <td align="left" class="l-table-edit-td"><input autocomplete="off" name="remark" type="text" id="remark" ltype="text" validate="{required:false,maxlength:100}" /></td>
            </tr>
    ...
    <script type="text/javascript">
        ...
        function saveFrom(){
        	if($("#parentId").val()==""){
        		$.ligerDialog.warn("请选择上级渠道");
        	}
        	else if($("#organId").val()==""){
        		$.ligerDialog.warn("请选择部门");
        	}
        	else{
		            $.post("${ctx}/channel/add.do", $("#form1").serialize(), function (msg) { 
		                if(msg=="true"){
