...
<head><title>
    ...
    <script type="text/javascript">
        ...
        var tree;
        $(function (){
        	tree=$("#tree1").ligerTree({ url: "${ctx}/menu/roleAccreditList.do?roleIds=${roleIds}", ajaxType: 'post',
            		                 idFieldName:"id",
            		                 textFieldName:"name",
        ...
        function saveFormSubmit(){
        	var ids = getChecked();
        	var roleIds="${roleIds}";
            $.post("${ctx}/menu/savePermission.do", {permissionIds:ids, roleIds:roleIds}, function (msg) { 
                if(msg=="true"){
