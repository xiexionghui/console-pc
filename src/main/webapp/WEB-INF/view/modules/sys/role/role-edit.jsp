...
<head><title>
    ...
    <script type="text/javascript">
        ...
        // 保存数据
        function saveFrom(){
            $.post("${ctx}/role/roleUpdate.do", $("#form1").serialize(), function (msg) { 
                if(msg=="true"){
...
<div>
        ...
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input autocomplete="off" name="name" type="text" id="name" value="${sysRole.name }" ltype="text" validate="{required:true,maxlength:100}" /></td>
                <td align="left"></td>
            </tr>
            
            <tr>
                <td align="right" class="l-table-edit-td">角色描述:</td>
                <td align="left" class="l-table-edit-td"><input autocomplete="off" name="description" type="text" id="description" value="${sysRole.description }" ltype="text" validate="{required:true,maxlength:200}" /></td>
                <td align="left"></td>
            </tr>
