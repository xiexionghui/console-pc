...
<div>
        ...
        <tr>
            ...
            <tr>
                <td align="right" class="l-table-edit-td">用户密码:&nbsp;&nbsp;<span style="color:red;">*</span></td>
                <td align="left" class="l-table-edit-td"><input autocomplete="off" name="password" type="password" id="password" ltype="text" validate="{required:true,minlength:6,maxlength:50}" /></td>
                <td align="right" class="l-table-edit-td">用户状态:&nbsp;&nbsp;<span style="color:red;">*</span></td>
                <td align="left" class="l-table-edit-td">
                    <input id="status_0" type="radio" name="status" value="0" checked="checked" /><label for="rbtnl_0">正常</label>  &nbsp; 
                    <input id="status_1" type="radio" name="status" value="1" /><label for="rbtnl_1">限制</label>
                </td>
            </tr>
            
            <tr>
                <td align="right" class="l-table-edit-td">确认密码:&nbsp;&nbsp;<span style="color:red;">*</span></td>
                <td align="left" class="l-table-edit-td"><input autocomplete="off" value="" name="password2" type="password" id="password2" ltype="text" validate="{required:true,minlength:6,maxlength:50}" /></td>
                <td align="right" class="l-table-edit-td">用户性别:&nbsp;&nbsp;<span style="color:red;">*</span></td>
                <td align="left" class="l-table-edit-td">
                    <input id="sex_0" type="radio" name="sex" value="0" checked="checked" /><label for="rbtnl_0">男</label> &nbsp; 
                    <input id="sex_1" type="radio" name="sex" value="1" /><label for="rbtnl_1">女</label>
                </td>
            </tr>
        ...
        <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                    ...
                    <input id="organName" type="text" ltype="text" onclick="selectDepartment()" validate="{required:true}"/>
                </td>
    ...
    <script type="text/javascript">
        ...
        function saveFrom(){
            ...
            $.post("${ctx}/user/addUser.do", $("#form1").serialize(), function (msg) { 
                if(msg=="true"){
